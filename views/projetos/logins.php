...
<body>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="nav-link" href="/views/projetos/telas/tela1/tela1.php">Tela 1</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/views/projetos/telas/tela2/tela2.php">Tela 2</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/views/projetos/telas/tela3/tela3.php">Tela 3</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/views/projetos/telas/tela4/tela4.php">Tela 4</a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <footer class="bg-light text-center text-lg-start">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            2021 ©
            <a class="text-dark" href="https://www.linkedin.com/in/lucas-walmor-steinbach-borges-1a602915a/"
                target="_blank">Lucas Steinbach</a>
        </div>
        <!-- Copyright -->
    </footer>
    <!-- Footer -->
